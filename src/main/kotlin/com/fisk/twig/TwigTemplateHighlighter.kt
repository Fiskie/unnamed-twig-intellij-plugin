...
class TwigTemplateHighlighter(project: Project?, virtualFile: VirtualFile?, colors: EditorColorsScheme) : LayeredLexerEditorHighlighter(TwigHighlighter(), colors) {    init {
    ...
    val outerHighlighter = SyntaxHighlighter.PROVIDER.create(type!!, project, virtualFile)// deprecated in IDEA 12, still needed in IDEA 11 TODO remove when IDEA 11 support is dropped
