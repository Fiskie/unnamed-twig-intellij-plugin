...
import com.fisk.twig.util.TwigBraceUtil
...
class TwigTypedHandler : TypedHandlerDelegate() {
    /**
     * IDEA's default brace autocomplete is weird so we handle completion in
     * beforeCharTyped. If a pair of braces can be recognised, virtualise
